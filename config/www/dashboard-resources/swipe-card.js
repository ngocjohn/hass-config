				...
				if ((c++, 1 === e.nodeType)) {
					if (e.hasAttributes()) {
						const t = e.attributes,
							{ length: s } = t;
						let i = 0;
						for (let e = 0; e < s; e++) n(t[e].name, '$lit$') && i++;
						for (; i-- > 0; ) {
							const t = u[h],
								s = d.exec(t)[2],
								i = s.toLowerCase() + '$lit$',
							...
							e.removeAttribute(i);
							const n = r.split(a);
							this.parts.push({ type: 'attribute', index: c, name: s, strings: n }),
								(h += n.length - 1);
						}
					}
					...
					if (t.indexOf(s) >= 0) {
						...
						for (let t = 0; t < o; t++) {
							...
							if ('' === a) i = l();
								...
								null !== e &&
									n(e[2], '$lit$') &&
									(a = a.slice(0, e.index) + e[1] + e[2].slice(0, -'$lit$'.length) + e[3]),
									(i = document.createTextNode(a));
							}
							s.insertBefore(i, e), this.parts.push({ type: 'node', index: ++c });
						}
						'' === r[o] ? (s.insertBefore(l(), e), i.push(e)) : (e.data = r[o]), (h += o);
					}
				} else if (8 === e.nodeType)
					if (e.data === s) {
						const t = e.parentNode;
						(null !== e.previousSibling && c !== p) || (c++, t.insertBefore(l(), e)),
							(p = c),
							this.parts.push({ type: 'node', index: c }),
							null === e.nextSibling ? (e.data = '') : (i.push(e), c--),
							h++;
					} else {
						let t = -1;
...
function p(e, t) {
	...
	for (; a.nextNode(); ) {
		...
		for (
			...
			(n.index = null !== p ? -1 : n.index - l), (r = h(i, r)), (n = i[r]);
	}
	...
	_clone() {
		...
		for (; n < i.length; )
			if (((r = i[n]), o(r))) {
				for (; l < r.index; )
					l++,
						'TEMPLATE' === d.nodeName && (s.push(d), (a.currentNode = d.content)),
						null === (d = a.nextNode()) && ((a.currentNode = s.pop()), (d = a.nextNode()));
				if ('node' === r.type) {
					const e = this.processor.handleTextExpression(this.options);
					e.insertAfterNode(d.previousSibling), this.__parts.push(e);
				} else
					this.__parts.push(
						...this.processor.handleAttributeExpressions(d, r.name, r.strings, this.options)
					);
				n++;
	...
	getHTML() {
		...
		for (let r = 0; r < e; r++) {
			const e = this.strings[r],
				n = e.lastIndexOf('\x3c!--');
			a = (n > -1 || a) && -1 === e.indexOf('--\x3e', n + 1);
			const o = d.exec(e);
			t += null === o ? e + (a ? w : i) : e.substr(0, o.index) + o[1] + o[2] + '$lit$' + o[3] + s;
		}
...
class S {
	...
	_getValue() {
		...
		for (let i = 0; i < t; i++) {
			...
			if (void 0 !== t) {
				const e = t.value;
				if (y(e) || !x(e)) s += 'string' == typeof e ? e : String(e);
	...
	__commitIterable(e) {
		...
		for (const a of e)
			(s = t[i]),
				...
				s.commit(),
				i++;
		i < t.length && ((t.length = i), this.clear(s && s.endNode));
	}
...
class P {
	...
	commit() {
		...
		const e = this.__pendingValue,
			...
			s =
				null == e ||
				(null != t && (e.capture !== t.capture || e.once !== t.once || e.passive !== t.passive)),
			i = null != e && (null == t || s);
...
const k = (e) => e && (M ? { capture: e.capture, passive: e.passive, once: e.once } : e.capture);
function z(e) {
	let t = _.get(e.type);
	void 0 === t && ((t = { stringsArray: new WeakMap(), keyString: new Map() }), _.set(e.type, t));
	let i = t.stringsArray.get(e.strings);
	if (void 0 !== i) return i;
	const a = e.strings.join(s);
	return (
		(i = t.keyString.get(a)),
		void 0 === i && ((i = new r(e, e.getTemplateElement())), t.keyString.set(a, i)),
...
const I = new (class {
	handleAttributeExpressions(e, t, s, i) {
		...
		return '@' === a
			? [new P(e, t.slice(1), i.eventContext)]
			: '?' === a
			? [new C(e, t.slice(1), s)]
			: new S(e, t, s).parts;
	}
...
const B = (e) => (t) => {
		const i = N(t.type, e);
		let a = _.get(i);
		void 0 === a && ((a = { stringsArray: new WeakMap(), keyString: new Map() }), _.set(i, a));
		let n = a.stringsArray.get(t.strings);
		if (void 0 !== n) return n;
		const o = t.strings.join(s);
		if (((n = a.keyString.get(o)), void 0 === n)) {
			const s = t.getTemplateElement();
			D && window.ShadyCSS.prepareTemplateDom(s, e), (n = new r(t, s)), a.keyString.set(o, n);
		}
	...
	V = (e, t, s) => {
		...
		const i = s ? s.element : document.createElement('template'),
			...
			{ length: r } = a;
		if (0 === r) return void window.ShadyCSS.prepareTemplateStyles(i, e);
		...
		s
			? (function (e, t, s = null) {
					...
					if (null == s) return void i.appendChild(t);
					...
					for (; r.nextNode(); ) {
						for (
							l++, r.currentNode === s && ((o = c(t)), s.parentNode.insertBefore(t, s));
							-1 !== n && a[n].index === l;

						) {
							if (o > 0) {
								for (; -1 !== n; ) (a[n].index += o), (n = h(a, n));
								return;
							}
							n = h(a, n);
						}
...
const H = {
	...
	R = (e, t) => t !== e && (t == t || e == e),
	F = { attribute: !0, type: String, converter: H, reflect: !1, hasChanged: R };
class X extends HTMLElement {
	...
	static get observedAttributes() {
		...
		return (
			this._classProperties.forEach((t, s) => {
				...
				void 0 !== i && (this._attributeToPropertyMap.set(i, s), e.push(i));
			}),
			e
		);
	}
	...
	static getPropertyDescriptor(e, t, s) {
		return {
			...
			set(s) {
				const i = this[e];
				(this[t] = s), this._requestUpdate(e, i);
			},
			configurable: !0,
			enumerable: !0,
		};
	...
	static getPropertyOptions(e) {
		return (this._classProperties && this._classProperties.get(e)) || F;
	}
	static finalize() {
	...
	static _valueHasChanged(e, t, s = R) {
		return s(e, t);
	}
	...
	static _propertyValueToAttribute(e, t) {
		...
		const s = t.type,
			i = t.converter;
		return ((i && i.toAttribute) || H.toAttribute)(e, s);
	}
	initialize() {
	...
	_propertyToAttribute(e, t, s = F) {
		const i = this.constructor,
			a = i._attributeNameForProperty(e, s);
		if (void 0 !== a) {
	...
	_requestUpdate(e, t) {
		...
		if (void 0 !== e) {
			const i = this.constructor,
				a = i.getPropertyOptions(e);
			i._valueHasChanged(this[e], t, a.hasChanged)
...
class Q extends X {
	...
	static _getUniqueStyles() {
		...
		if (void 0 === e) this._styles = [];
			...
			const t = (e, s) => e.reduceRight((e, s) => (Array.isArray(s) ? t(s, e) : (e.add(s), e)), s),
				s = t(e, new Set()),
				i = [];
			s.forEach((e) => i.unshift(e)), (this._styles = i);
		} else this._styles = [e];
	}
	initialize() {
		super.initialize(),
...
(Q.finalized = !0),
	(Q.render = (e, s, i) => {
		...
		const a = i.scopeName,
			r = L.has(s),
			n = D && 11 === s.nodeType && !!s.host,
			o = n && !Y.has(a),
			l = o ? document.createDocumentFragment() : s;
		if (
			(((e, s, i) => {
				let a = L.get(s);
				void 0 === a &&
					(t(s, s.firstChild),
					L.set(s, (a = new T(Object.assign({ templateFactory: z }, i)))),
					a.appendInto(s)),
					a.setValue(e),
					a.commit();
			})(e, l, Object.assign({ templateFactory: B(a) }, i)),
			o)
		) {
			const e = L.get(l);
			L.delete(l);
			const i = e.value instanceof v ? e.value.template : void 0;
			V(a, l, i), t(s, s.firstChild), s.appendChild(l), L.set(s, e);
		}
		!r && n && window.ShadyCSS.styleElement(s.host);
	});
var ee = 'undefined' != typeof document ? document : {},
	te = {
		body: {},
...
J(ee, te);
var se = 'undefined' != typeof window ? window : {};
J(se, {
	document: te,
	navigator: { userAgent: '' },
	location: {
		...
		if ('string' == typeof e) {
			...
			if (n.indexOf('<') >= 0 && n.indexOf('>') >= 0) {
				...
				for (
					a =
						t || '#' !== e[0] || e.match(/[ .<>:~]/)
							? (t || ee).querySelectorAll(e.trim())
							: [ee.getElementById(e.trim().split('#')[1])],
						i = 0;
					i < a.length;
					i += 1
				)
					a[i] && s.push(a[i]);
		} else if (e.nodeType || e === se || e === ee) s.push(e);
...
(ae.fn = ie.prototype), (ae.Class = ie), (ae.Dom7 = ie);
const ne = {
	addClass: function (e) {
	...
	on: function (...e) {
		...
		function r(e) {
			...
			if ((a.indexOf(e) < 0 && a.unshift(e), ae(t).is(s))) i.apply(t, a);
			else {
				const e = ae(t).parents();
				for (let t = 0; t < e.length; t += 1) ae(e[t]).is(s) && i.apply(e[t], a);
			}
		}
		function n(e) {
				...
				if (
					...
					for (let e = n.length - 1; e >= 0; e -= 1) {
						...
						(i && s.listener && s.listener.dom7proxy && s.listener.dom7proxy === i)
							? (r.removeEventListener(t, s.proxyListener, a), n.splice(e, 1))
							: i || (r.removeEventListener(t, s.proxyListener, a), n.splice(e, 1));
					}
			}
		}
		return this;
	...
	trigger: function (...e) {
		...
		for (let i = 0; i < t.length; i += 1) {
			...
			for (let t = 0; t < this.length; t += 1) {
				...
				let r;
				try {
					r = new se.CustomEvent(a, { detail: s, bubbles: !0, cancelable: !0 });
				} catch (e) {
					(r = ee.createEvent('Event')), r.initEvent(a, !0, !0), (r.detail = s);
				}
	...
	transitionEnd: function (e) {
		...
		let i;
		function a(r) {
			if (r.target === this) for (e.call(this, r), i = 0; i < t.length; i += 1) s.off(t[i], a);
		}
	...
	offset: function () {
		if (this.length > 0) {
			const e = this[0],
				...
				n = e === se ? se.scrollX : e.scrollLeft;
			return { top: t.top + r - i, left: t.left + n - a };
		}
		return null;
	},
	css: function (e, t) {
	...
	is: function (e) {
		...
		if ('string' == typeof e) {
			...
			for (s = ae(e), i = 0; i < s.length; i += 1) if (s[i] === t) return !0;
			return !1;
		}
		if (e === ee) return t === ee;
		if (e === se) return t === se;
		if (e.nodeType || e instanceof ie) {
	...
	append: function (...e) {
		...
		for (let s = 0; s < e.length; s += 1) {
			...
			for (let e = 0; e < this.length; e += 1)
				if ('string' == typeof t) {
					const s = ee.createElement('div');
					for (s.innerHTML = t; s.firstChild; ) this[e].appendChild(s.firstChild);
				} else if (t instanceof ie) for (let s = 0; s < t.length; s += 1) this[e].appendChild(t[s]);
		...
		return this.length > 0
			? e
				? this[0].nextElementSibling && ae(this[0].nextElementSibling).is(e)
					? new ie([this[0].nextElementSibling])
					: new ie([])
		...
		if (this.length > 0) {
			...
			return e
				? t.previousElementSibling && ae(t.previousElementSibling).is(e)
					? new ie([t.previousElementSibling])
					: new ie([])
	...
	parents: function (e) {
		...
		for (let s = 0; s < this.length; s += 1) {
			...
			for (; i; ) e ? ae(i).is(e) && t.push(i) : t.push(i), (i = i.parentNode);
		}
		return ae(re(t));
	},
	closest: function (e) {
	...
	children: function (e) {
		...
		for (let s = 0; s < this.length; s += 1) {
			...
			for (let s = 0; s < i.length; s += 1)
				e
					? 1 === i[s].nodeType && ae(i[s]).is(e) && t.push(i[s])
...
const oe = {
		...
		getTranslate(e, t = 'x') {
			let s, i, a;
			const r = se.getComputedStyle(e, null);
			return (
				se.WebKitCSSMatrix
					? ((i = r.transform || r.webkitTransform),
					  i.split(',').length > 6 &&
							(i = i
								...
								.map((e) => e.replace(',', '.'))
								.join(', ')),
					  (a = new se.WebKitCSSMatrix('none' === i ? '' : i)))
					: ((a =
							r.MozTransform ||
							r.OTransform ||
							r.MsTransform ||
					  ...
					  (s = a.toString().split(','))),
				'x' === t &&
					(i = se.WebKitCSSMatrix ? a.m41 : 16 === s.length ? parseFloat(s[12]) : parseFloat(s[4])),
				'y' === t &&
					(i = se.WebKitCSSMatrix ? a.m42 : 16 === s.length ? parseFloat(s[13]) : parseFloat(s[5])),
				i || 0
			);
		},
		parseUrlQuery(e) {
			...
			let s,
				...
				a,
				r,
				n = e || se.location.href;
			if ('string' == typeof n && n.length)
				for (
					n = n.indexOf('?') > -1 ? n.replace(/\S*\?/, '') : '',
						i = n.split('&').filter((e) => '' !== e),
						r = i.length,
						s = 0;
					s < r;
					s += 1
			...
			for (let s = 1; s < e.length; s += 1) {
				...
				if (null != i) {
					...
					for (let s = 0, a = e.length; s < a; s += 1) {
						...
						void 0 !== r &&
							r.enumerable &&
							(oe.isObject(t[a]) && oe.isObject(i[a])
								? oe.extend(t[a], i[a])
								: !oe.isObject(t[a]) && oe.isObject(i[a])
								? ((t[a] = {}), oe.extend(t[a], i[a]))
								: (t[a] = i[a]));
					}
				}
			}
	...
	le = {
		touch: !!('ontouchstart' in se || (se.DocumentTouch && ee instanceof se.DocumentTouch)),
		pointerEvents:
			!!se.PointerEvent && 'maxTouchPoints' in se.navigator && se.navigator.maxTouchPoints >= 0,
...
class de {
	...
	static installModule(e, ...t) {
		...
		const i = e.name || `${Object.keys(s.prototype.modules).length}_${oe.now()}`;
		return (
...
var pe = {
	updateSize: function () {
		...
		(t = void 0 !== e.params.width ? e.params.width : i[0].clientWidth),
			...
			(0 === t && e.isHorizontal()) ||
				...
				oe.extend(e, { width: t, height: s, size: e.isHorizontal() ? t : s }));
	},
	updateSlides: function () {
		const e = this,
			t = e.params,
			{ $wrapperEl: s, size: i, rtlTranslate: a, wrongRTL: r } = e,
		...
		for (let s = 0; s < d; s += 1) {
				...
				if ('row' === t.slidesPerColumnFill && t.slidesPerGroup > 1) {
					const e = Math.floor(s / (t.slidesPerGroup * t.slidesPerColumn)),
						...
						l =
							0 === e
								? t.slidesPerGroup
								: Math.min(Math.ceil((d - e * T * t.slidesPerGroup) / T), t.slidesPerGroup);
					(n = Math.floor(o / l)),
						(r = o - n * l + e * t.slidesPerGroup),
						(i = r + (n * w) / T),
						a.css({
					...
					'column' === t.slidesPerColumnFill
						? ((r = Math.floor(s / T)),
						  (n = s - r * T),
						  (r > A || (r === A && n === T - 1)) && ((n += 1), n >= T && ((n = 0), (r += 1))))
						: ((n = Math.floor(s / C)), (r = s - n * C));
				a.css(
			...
			if ('none' !== a.css('display')) {
				if ('auto' === t.slidesPerView) {
					const s = se.getComputedStyle(a[0], null),
					...
					if (
						...
						b = e.isHorizontal() ? a.outerWidth(!0) : a.outerHeight(!0);
						...
						b = n && 'border-box' === n ? e + a + r : e + t + i + a + r;
					} else {
					...
					(b = (i - (t.slidesPerView - 1) * y) / t.slidesPerView),
						t.roundLengths && (b = Math.floor(b)),
						l[s] &&
							(e.isHorizontal() ? (l[s].style.width = `${b}px`) : (l[s].style.height = `${b}px`));
		...
		if (
			...
			t.slidesPerColumn > 1 &&
				((e.virtualSize = (b + t.spaceBetween) * w),
		...
		oe.extend(e, { slides: l, snapGrid: p, slidesGrid: c, slidesSizesGrid: h }),
	...
	updateSlidesProgress: function (e = (this && this.translate) || 0) {
		...
		for (let e = 0; e < i.length; e += 1) {
			const n = i[e],
				o =
					(r + (s.centeredSlides ? t.minTranslate() : 0) - n.swiperSlideOffset) /
	...
	updateProgress: function (e) {
		...
		0 === i
			? ((a = 0), (r = !0), (n = !0))
			: ((a = (e - t.minTranslate()) / i), (r = a <= 0), (n = a >= 1)),
			oe.extend(t, { progress: a, isBeginning: r, isEnd: n }),
	...
	updateSlidesClasses: function () {
		const e = this,
			{ slides: t, params: s, $wrapperEl: i, activeIndex: a, realIndex: r } = e,
			n = e.virtual && s.virtual.enabled;
		let o;
		t.removeClass(
			`${s.slideActiveClass} ${s.slideNextClass} ${s.slidePrevClass} ${s.slideDuplicateActiveClass} ${s.slideDuplicateNextClass} ${s.slideDuplicatePrevClass}`
		),
			(o = n ? e.$wrapperEl.find(`.${s.slideClass}[data-swiper-slide-index="${a}"]`) : t.eq(a)),
	...
	updateActiveIndex: function (e) {
		...
		if ((d >= a.length && (d = a.length - 1), p === n))
			return void (d !== l && ((t.snapIndex = d), t.emit('snapIndexChange')));
		const c = parseInt(t.slides.eq(p).attr('data-swiper-slide-index') || p, 10);
		oe.extend(t, { snapIndex: d, realIndex: c, previousIndex: n, activeIndex: p }),
	...
	updateClickedSlide: function (e) {
		const t = this,
			s = t.params,
			i = ae(e.target).closest(`.${s.slideClass}`)[0];
		let a = !1;
		...
		(t.clickedSlide = i),
			t.virtual && t.params.virtual.enabled
				? (t.clickedIndex = parseInt(ae(i).attr('data-swiper-slide-index'), 10))
				: (t.clickedIndex = ae(i).index()),
...
var ce = {
	...
	setTranslate: function (e, t) {
		...
		s.isHorizontal() ? (d = i ? -e : e) : (p = e),
			...
			a.cssMode
				...
				: a.virtualTranslate || r.transform(`translate3d(${d}px, ${p}px, 0px)`),
	...
	translateTo: function (e = 0, t = this.params.speed, s = !0, i = !0, a) {
		...
		const l = r.minTranslate(),
			d = r.maxTranslate();
		let p;
		if (((p = i && e > l ? l : i && e < d ? d : e), r.updateProgress(p), n.cssMode)) {
...
var he = {
	...
	transitionStart: function (e = !0, t) {
		const s = this,
			{ activeIndex: i, params: a, previousIndex: r } = s;
		if (a.cssMode) return;
		...
		if (
			...
			s.emit('slideChangeTransitionStart'),
				'next' === n ? s.emit('slideNextTransitionStart') : s.emit('slidePrevTransitionStart');
		}
	},
	transitionEnd: function (e = !0, t) {
		const s = this,
			{ activeIndex: i, previousIndex: a, params: r } = s;
		if (((s.animating = !1), r.cssMode)) return;
		s.setTransition(0);
		let n = t;
		if (
			(n || (n = i > a ? 'next' : i < a ? 'prev' : 'reset'), s.emit('transitionEnd'), e && i !== a)
		) {
...
var ue = {
	slideTo: function (e = 0, t = this.params.speed, s = !0, i) {
		...
		const u = Math.min(a.params.slidesPerGroupSkip, r);
		let m = u + Math.floor((r - u) / a.params.slidesPerGroup);
		m >= o.length && (m = o.length - 1),
			(p || n.initialSlide || 0) === (d || 0) && s && a.emit('beforeSlideChangeStart');
		const g = -o[m];
		if ((a.updateProgress(g), n.normalizeSlideIndex))
			for (let e = 0; e < l.length; e += 1)
				-Math.floor(100 * g) >= Math.floor(100 * l[e]) && (r = e);
		if (a.initialized && r !== p) {
			if (!a.allowSlideNext && g < a.translate && g < a.minTranslate()) return !1;
			if (!a.allowSlidePrev && g > a.translate && g > a.maxTranslate() && (p || 0) !== r) return !1;
		}
		let f;
		if (
			((f = r > p ? 'next' : r < p ? 'prev' : 'reset'),
			(c && -g === a.translate) || (!c && g === a.translate))
		)
			return (
				a.updateActiveIndex(r),
				n.autoHeight && a.updateAutoHeight(),
				a.updateSlidesClasses(),
				'slide' !== n.effect && a.setTranslate(g),
	...
	slidePrev: function (e = this.params.speed, t = !0, s) {
		const i = this,
			{ params: a, animating: r, snapGrid: n, slidesGrid: o, rtlTranslate: l } = i;
		if (a.loop) {
			if (r) return !1;
			i.loopFix(), (i._clientLeft = i.$wrapperEl[0].clientLeft);
		}
		...
		return (
			...
			void 0 !== u && ((h = o.indexOf(u)), h < 0 && (h = i.activeIndex - 1)),
			i.slideTo(h, e, t, s)
		);
	},
	...
	slideToClickedSlide: function () {
		...
		if (t.loop) {
			...
			(a = parseInt(ae(e.clickedSlide).attr('data-swiper-slide-index'), 10)),
				t.centeredSlides
	...
	loopCreate: function () {
		...
		if (t.loopFillGroupWithBlank) {
			...
			if (e !== t.slidesPerGroup) {
				for (let i = 0; i < e; i += 1) {
					const e = ae(ee.createElement('div')).addClass(`${t.slideClass} ${t.slideBlankClass}`);
					s.append(e);
				}
		...
		for (let e = 0; e < r.length; e += 1)
			s.append(ae(r[e].cloneNode(!0)).addClass(t.slideDuplicateClass));
		for (let e = a.length - 1; e >= 0; e -= 1)
			s.prepend(ae(a[e].cloneNode(!0)).addClass(t.slideDuplicateClass));
	},
	loopFix: function () {
		const e = this;
...
var fe = {
	appendSlide: function (e) {
		...
		i.loop && t.loopCreate(), (i.observer && le.observer) || t.update();
	},
	prependSlide: function (e) {
		...
		s.loop && t.loopCreate(), (s.observer && le.observer) || t.update(), t.slideTo(r, 0, !1);
	},
	addSlide: function (e, t) {
		...
		a.loop && s.loopCreate(),
			(a.observer && le.observer) || s.update(),
	...
	removeSlide: function (e) {
		...
		if ('object' == typeof e && 'length' in e) {
			for (let s = 0; s < e.length; s += 1)
				(n = e[s]), t.slides[n] && t.slides.eq(n).remove(), n < o && (o -= 1);
			o = Math.max(o, 0);
		} else (n = e), t.slides[n] && t.slides.eq(n).remove(), n < o && (o -= 1), (o = Math.max(o, 0));
		s.loop && t.loopCreate(),
			(s.observer && le.observer) || t.update(),
...
const ve = (function () {
	const e = se.navigator.platform,
		t = se.navigator.userAgent,
		s = {
			ios: !1,
			android: !1,
			androidChrome: !1,
	...
	return (
		...
		o && ((s.osVersion = o[3] ? o[3].replace(/_/g, '.') : null), (s.ipod = !0)),
		s.ios &&
			s.osVersion &&
			t.indexOf('Version/') >= 0 &&
		...
		(s.webView =
			!(!(l || n || o) || (!t.match(/.*AppleWebKit(?!.*Safari)/i) && !se.navigator.standalone)) ||
			(se.matchMedia && se.matchMedia('(display-mode: standalone)').matches)),
		(s.webview = s.webView),
		(s.standalone = s.webView),
		(s.desktop = !(s.ios || s.android) || u),
		s.desktop &&
			((s.electron = u),
			(s.macos = m),
			(s.windows = h),
		...
		(s.pixelRatio = se.devicePixelRatio || 1),
		s
	);
})();
function we(e) {
	...
	const n = ae(r.target);
	if ('wrapper' === i.touchEventsTarget && !n.closest(t.wrapperEl).length) return;
	if (
	...
	if (
		i.noSwiping &&
		n.closest(i.noSwipingSelector ? i.noSwipingSelector : `.${i.noSwipingClass}`)[0]
	)
		return void (t.allowClick = !0);
	if (i.swipeHandler && !n.closest(i.swipeHandler)[0]) return;
	...
	if (!d || !(o <= p || o >= se.screen.width - p)) {
		if (
			...
			let e = !0;
			n.is(s.formElements) && (e = !1),
				ee.activeElement &&
					ae(ee.activeElement).is(s.formElements) &&
					ee.activeElement !== n[0] &&
					ee.activeElement.blur();
...
function be(e) {
	...
	if ((n.originalEvent && (n = n.originalEvent), !s.isTouched))
		return void (s.startMoving && s.isScrolling && t.emit('touchMoveOpposite', n));
	if (s.isTouchEvent && 'touchmove' !== n.type) return;
	const o =
			'touchmove' === n.type && n.targetTouches && (n.targetTouches[0] || n.changedTouches[0]),
	...
	if (!t.allowTouchMove)
		return (
			...
			void (
				s.isTouched &&
				(oe.extend(a, { startX: l, startY: d, currentX: l, currentY: d }),
				(s.touchStartTime = oe.now()))
			)
		);
	...
	if (
		s.isTouchEvent &&
		ee.activeElement &&
		n.target === ee.activeElement &&
		ae(n.target).is(s.formElements)
	)
		return (s.isMoved = !0), void (t.allowClick = !1);
	if (
		(s.allowTouchCallbacks && t.emit('touchMove', n), n.targetTouches && n.targetTouches.length > 1)
	)
		return;
	...
	if (
		...
		void 0 === s.startMoving &&
			((a.currentX === a.startX && a.currentY === a.startY) || (s.startMoving = !0)),
		s.isScrolling)
	)
	...
	if (
		...
		h > 0 && s.currentTranslate > t.minTranslate()
			? ((u = !1),
			  i.resistance &&
					(s.currentTranslate =
						t.minTranslate() - 1 + (-t.minTranslate() + s.startTranslate + h) ** m))
			: h < 0 &&
			  s.currentTranslate < t.maxTranslate() &&
			  ((u = !1),
			  i.resistance &&
					(s.currentTranslate =
						t.maxTranslate() + 1 - (t.maxTranslate() - s.startTranslate - h) ** m)),
...
function ye(e) {
	const t = this,
		s = t.touchEventsData,
		{ params: i, touches: a, rtlTranslate: r, $wrapperEl: n, slidesGrid: o, snapGrid: l } = t;
	let d = e;
	if (
		...
		return (
			s.isMoved && i.grabCursor && t.setGrabCursor(!1), (s.isMoved = !1), void (s.startMoving = !1)
		);
	i.grabCursor &&
		s.isMoved &&
		s.isTouched &&
	...
	if (
		(t.allowClick &&
			...
			t.emit('tap click', d),
			c < 300 && p - s.lastClickTime < 300 && t.emit('doubleTap doubleClick', d)),
		(s.lastClickTime = oe.now()),
		oe.nextTick(() => {
	...
	if (
		...
		(s.isMoved = !1),
		(s.startMoving = !1),
		(h = i.followFinger ? (r ? t.translate : -t.translate) : -s.currentTranslate),
		i.cssMode)
	)
		return;
	if (i.freeMode) {
		...
		if (i.freeModeMomentum) {
			if (s.velocities.length > 1) {
				...
				(t.velocity = r / n),
					...
					(n > 150 || oe.now() - e.time > 300) && (t.velocity = 0);
			} else t.velocity = 0;
			...
			if (o < t.maxTranslate())
				i.freeModeMomentumBounce
					? (o + t.maxTranslate() < -c && (o = t.maxTranslate() - c),
					  (d = t.maxTranslate()),
					  (p = !0),
				...
				(o =
					Math.abs(l[e] - o) < Math.abs(l[e - 1] - o) || 'next' === t.swipeDirection
						? l[e]
						: l[e - 1]),
					(o = -o);
			}
	...
	for (let e = 0; e < o.length; e += e < i.slidesPerGroupSkip ? 1 : i.slidesPerGroup) {
		...
		void 0 !== o[e + t]
			? h >= o[e] && h < o[e + t] && ((u = e), (m = o[e + t] - o[e]))
			: h >= o[e] && ((u = e), (m = o[o.length - 1] - o[o.length - 2]));
	}
	const g = (h - o[u]) / m,
		f = u < i.slidesPerGroupSkip - 1 ? 1 : i.slidesPerGroup;
	if (c > i.longSwipesMs) {
		if (!i.longSwipes) return void t.slideTo(t.activeIndex);
		'next' === t.swipeDirection && (g >= i.longSwipesRatio ? t.slideTo(u + f) : t.slideTo(u)),
			'prev' === t.swipeDirection && (g > 1 - i.longSwipesRatio ? t.slideTo(u + f) : t.slideTo(u));
	} else {
...
function Ee() {
	...
	(e.previousTranslate = e.translate),
		e.isHorizontal()
			? (e.translate = s ? t.scrollWidth - t.offsetWidth - t.scrollLeft : -t.scrollLeft)
...
const $e = {
		...
		events: {
			attachEvents: function () {
				...
				(e.onTouchStart = we.bind(e)),
					...
					(e.onClick = Se.bind(e));
				const r = !!t.nested;
				if (!le.touch && le.pointerEvents)
					i.addEventListener(s.start, e.onTouchStart, !1),
						ee.addEventListener(s.move, e.onTouchMove, r),
						ee.addEventListener(s.end, e.onTouchEnd, !1);
				else {
					if (le.touch) {
						const a = !('touchstart' !== s.start || !le.passiveListener || !t.passiveListeners) && {
							passive: !0,
							capture: !1,
						};
						i.addEventListener(s.start, e.onTouchStart, a),
							i.addEventListener(
								s.move,
								e.onTouchMove,
								le.passiveListener ? { passive: !1, capture: r } : r
							),
							i.addEventListener(s.end, e.onTouchEnd, a),
							s.cancel && i.addEventListener(s.cancel, e.onTouchEnd, a),
							Te || (ee.addEventListener('touchstart', Ce), (Te = !0));
					}
					((t.simulateTouch && !ve.ios && !ve.android) ||
						(t.simulateTouch && !le.touch && ve.ios)) &&
						(i.addEventListener('mousedown', e.onTouchStart, !1),
						ee.addEventListener('mousemove', e.onTouchMove, r),
						ee.addEventListener('mouseup', e.onTouchEnd, !1));
				}
			...
			detachEvents: function () {
				...
				if (!le.touch && le.pointerEvents)
					i.removeEventListener(s.start, e.onTouchStart, !1),
						ee.removeEventListener(s.move, e.onTouchMove, r),
						ee.removeEventListener(s.end, e.onTouchEnd, !1);
				else {
					if (le.touch) {
						const a = !(
					...
					((t.simulateTouch && !ve.ios && !ve.android) ||
						...
						ee.removeEventListener('mousemove', e.onTouchMove, r),
						ee.removeEventListener('mouseup', e.onTouchEnd, !1));
				}
				(t.preventClicks || t.preventClicksPropagation) &&
		...
		breakpoints: {
			setBreakpoint: function () {
				const e = this,
					{ activeIndex: t, initialized: s, loopedSlides: i = 0, params: a, $el: r } = e,
					n = a.breakpoints;
		...
		images: {
			loadImage: function (e, t, s, i, a, r) {
				...
				ae(e).parent('picture')[0] || (e.complete && a)
					? o()
					: t
					? ((n = new se.Image()),
					  (n.onload = o),
...
class Pe extends de {
	constructor(...e) {
		...
		1 === e.length && e[0].constructor && e[0].constructor === Object ? (s = e[0]) : ([t, s] = e),
			...
			Object.keys($e).forEach((e) => {
				Object.keys($e[e]).forEach((t) => {
					Pe.prototype[t] || (Pe.prototype[t] = $e[e][t]);
				});
			});
		const i = this;
		...
		const a = oe.extend({}, Ae);
		i.useModulesParams(a),
			(i.params = oe.extend({}, a, Me, s)),
			(i.originalParams = oe.extend({}, i.params)),
			(i.passedParams = oe.extend({}, s)),
			(i.$ = ae);
		const r = ae(i.params.el);
		if (((t = r[0]), !t)) return;
		if (r.length > 1) {
			const e = [];
			return (
				r.each((t, i) => {
					const a = oe.extend({}, s, { el: i });
					e.push(new Pe(a));
				}),
				e
			);
		...
		return (
			...
			t && t.shadowRoot && t.shadowRoot.querySelector
				? ((n = ae(t.shadowRoot.querySelector(`.${i.params.wrapperClass}`))),
				  (n.children = (e) => r.children(e)))
				: (n = r.children(`.${i.params.wrapperClass}`)),
			oe.extend(i, {
				$el: r,
				el: t,
				$wrapperEl: n,
				...
				touchEvents: (function () {
					...
					return (
						le.pointerEvents && (t = ['pointerdown', 'pointermove', 'pointerup']),
						(i.touchEventsTouch = { start: e[0], move: e[1], end: e[2], cancel: e[3] }),
						(i.touchEventsDesktop = { start: t[0], move: t[1], end: t[2] }),
						le.touch || !i.params.simulateTouch ? i.touchEventsTouch : i.touchEventsDesktop
					);
				})(),
				touchEventsData: {
					isTouched: void 0,
	...
	slidesPerViewDynamic() {
		...
		if (e.centeredSlides) {
			...
			for (let n = a + 1; n < t.length; n += 1)
				t[n] && !e && ((s += t[n].swiperSlideSize), (r += 1), s > i && (e = !0));
			for (let n = a - 1; n >= 0; n -= 1)
				t[n] && !e && ((s += t[n].swiperSlideSize), (r += 1), s > i && (e = !0));
		} else for (let e = a + 1; e < t.length; e += 1) s[e] - s[a] < i && (r += 1);
		return r;
	}
	update() {
		const e = this;
	...
	destroy(e = !0, t = !0) {
		...
		return (
			void 0 === s.params ||
				...
				!1 !== e && ((s.$el[0].swiper = null), s.$el.data('swiper', null), oe.deleteProps(s)),
				(s.destroyed = !0)),
			null
		);
	}
...
var ke = { name: 'device', proto: { device: ve }, static: { device: ve } },
	ze = { name: 'support', proto: { support: le }, static: { support: le } };
const _e = {
	isEdge: !!se.navigator.userAgent.match(/Edge/g),
	isSafari: (function () {
		const e = se.navigator.userAgent.toLowerCase();
		return e.indexOf('safari') >= 0 && e.indexOf('chrome') < 0 && e.indexOf('android') < 0;
	})(),
	isWebView: /(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(se.navigator.userAgent),
};
var Le = { name: 'browser', proto: { browser: _e }, static: { browser: _e } },
	Ie = {
		name: 'resize',
		create() {
			const e = this;
		...
		on: {
			init() {
				se.addEventListener('resize', this.resize.resizeHandler),
					se.addEventListener('orientationchange', this.resize.orientationChangeHandler);
			},
			destroy() {
				se.removeEventListener('resize', this.resize.resizeHandler),
					se.removeEventListener('orientationchange', this.resize.orientationChangeHandler);
			},
		},
	};
const Oe = {
	...
	init() {
		const e = this;
		if (le.observer && e.params.observer) {
...
const De = {
	update(e) {
		const t = this,
			...
			{ from: o, to: l, slides: d, slidesGrid: p, renderSlide: c, offset: h } = t.virtual;
		t.updateActiveIndex();
		const u = t.activeIndex || 0;
		let m, g, f;
		(m = t.rtlTranslate ? 'right' : t.isHorizontal() ? 'left' : 'top'),
			a
				? ((g = Math.floor(s / 2) + i + r), (f = Math.floor(s / 2) + i + n))
				: ((g = s + (i - 1) + r), (f = i + n));
		...
		if (
			(oe.extend(t.virtual, { from: v, to: w, offset: b, slidesGrid: t.slidesGrid }),
			o === v && l === w && !e)
		)
			return t.slidesGrid !== p && b !== h && t.slides.css(m, `${b}px`), void t.updateProgress();
		...
		for (let t = 0; t < d.length; t += 1)
			t >= v &&
				t <= w &&
				(void 0 === l || e ? S.push(t) : (t > l && S.push(t), t < o && x.push(t)));
		S.forEach((e) => {
	...
	renderSlide(e, t) {
		...
		const a = i.renderSlide
			? ae(i.renderSlide.call(s, e, t))
			: ae(`<div class="${s.params.slideClass}" data-swiper-slide-index="${t}">${e}</div>`);
		return (
...
var Be = {
	...
	on: {
		beforeInit() {
			...
			oe.extend(e.params, t),
				oe.extend(e.originalParams, t),
...
const Ge = {
	handle(e) {
		...
		if (
			!t.allowSlideNext &&
			((t.isHorizontal() && 39 === a) || (t.isVertical() && 40 === a) || 34 === a)
		)
			return !1;
		if (
			!t.allowSlidePrev &&
			((t.isHorizontal() && 37 === a) || (t.isVertical() && 38 === a) || 33 === a)
		)
			return !1;
		if (
			!(
				...
				i.metaKey ||
				(ee.activeElement &&
					ee.activeElement.nodeName &&
					('input' === ee.activeElement.nodeName.toLowerCase() ||
						'textarea' === ee.activeElement.nodeName.toLowerCase()))
			)
		) {
			if (
	...
	enable() {
		this.keyboard.enabled ||
			(ae(ee).on('keydown', this.keyboard.handle), (this.keyboard.enabled = !0));
	},
	disable() {
		this.keyboard.enabled &&
			(ae(ee).off('keydown', this.keyboard.handle), (this.keyboard.enabled = !1));
	},
};
var Ye = {
	name: 'keyboard',
...
const Ve = {
	...
	recentWheelEvents: [],
	event: () =>
		se.navigator.userAgent.indexOf('firefox') > -1
			? 'DOMMouseScroll'
			: (function () {
					let e = 'onwheel' in ee;
					if (!e) {
						const t = ee.createElement('div');
						t.setAttribute('onwheel', 'return;'), (e = 'function' == typeof t.onwheel);
					}
					return (
						!e &&
							ee.implementation &&
							ee.implementation.hasFeature &&
							!0 !== ee.implementation.hasFeature('', '') &&
							(e = ee.implementation.hasFeature('Events.wheel', '3.0')),
						e
					);
			  })()
			? 'wheel'
	...
	handle(e) {
		...
		if (
			('container' !== s.params.mousewheel.eventsTarged &&
				(a = ae(s.params.mousewheel.eventsTarged)),
		...
		if ((i.invert && (r = -r), s.params.freeMode)) {
			const e = { time: oe.now(), delta: Math.abs(r), direction: Math.sign(r) },
				...
				if (
					...
					if ((t.push(e), i && (e.delta > i.delta || e.direction !== i.direction))) t.splice(0);
						...
						(s.mousewheel.lastEventBeforeSnap = e),
							t.splice(0),
							(s.mousewheel.timeout = oe.nextTick(() => {
			...
			const t = { time: oe.now(), delta: Math.abs(r), direction: Math.sign(r), raw: e },
	...
	animateSlider(e) {
		const t = this;
		return (
			(e.delta >= 6 && oe.now() - t.mousewheel.lastScrollTime < 60) ||
			(e.direction < 0
	...
	enable() {
		...
		return (
			'container' !== e.params.mousewheel.eventsTarged &&
				(s = ae(e.params.mousewheel.eventsTarged)),
...
const He = {
	...
	init() {
		...
		t.nextEl &&
			...
			oe.extend(e.navigation, { $nextEl: s, nextEl: s && s[0], $prevEl: i, prevEl: i && i[0] });
	},
	destroy() {
		const e = this,
		...
		t &&
			t.length &&
			(t.off('click', e.navigation.onNextClick), t.removeClass(e.params.navigation.disabledClass)),
			s &&
				s.length &&
...
const Re = {
	update() {
		...
		if (
			...
			if (
				...
				i.each((e, t) => {
					const i = ae(t),
						a = i.index();
					a === r && i.addClass(s.bulletActiveClass),
						s.dynamicBullets &&
							(a >= n && a <= o && i.addClass(`${s.bulletActiveClass}-main`),
							a === n &&
								i
									.prev()
		...
		if (
			('fraction' === s.type &&
				(a.find(`.${s.currentClass}`).text(s.formatFractionCurrent(r + 1)),
				a.find(`.${s.totalClass}`).text(s.formatFractionTotal(n))),
			'progressbar' === s.type)
		) {
			let t;
		...
		'custom' === s.type && s.renderCustom
			? (a.html(s.renderCustom(e, r + 1, n)), e.emit('paginationRender', e, a[0]))
		...
		0 !== s.length &&
			...
			t.clickable &&
				s.on('click', `.${t.bulletClass}`, function (t) {
					t.preventDefault();
					let s = ae(this).index() * e.params.slidesPerGroup;
					e.params.loop && (s += e.loopedSlides), e.slideTo(s);
				}),
			oe.extend(e.pagination, { $el: s, el: s[0] }));
	},
	destroy() {
...
const Fe = {
	...
	updateSize() {
		...
		let o;
		(o =
			'auto' === e.params.scrollbar.dragSize ? a * r : parseInt(e.params.scrollbar.dragSize, 10)),
			e.isHorizontal() ? (s[0].style.width = `${o}px`) : (s[0].style.height = `${o}px`),
			(i[0].style.display = r >= 1 ? 'none' : ''),
			e.params.scrollbar.hide && (i[0].style.opacity = 0),
			oe.extend(t, { trackSize: a, divider: r, moveDivider: n, dragSize: o }),
	...
	setDragPosition(e) {
		const { scrollbar: t, rtlTranslate: s } = this,
			{ $el: i, dragSize: a, trackSize: r, dragStartPos: n } = t;
		let o;
		(o =
	...
	onDragEnd(e) {
		...
		t.scrollbar.isTouched &&
			...
			s.hide &&
				(clearTimeout(t.scrollbar.dragTimeout),
				(t.scrollbar.dragTimeout = oe.nextTick(() => {
	...
	enableDraggable() {
		...
		const { scrollbar: t, touchEventsTouch: s, touchEventsDesktop: i, params: a } = e,
			r = t.$el[0],
			n = !(!le.passiveListener || !a.passiveListeners) && { passive: !1, capture: !1 },
			o = !(!le.passiveListener || !a.passiveListeners) && { passive: !0, capture: !1 };
		le.touch
			? (r.addEventListener(s.start, e.scrollbar.onDragStart, n),
			  r.addEventListener(s.move, e.scrollbar.onDragMove, n),
			  r.addEventListener(s.end, e.scrollbar.onDragEnd, o))
			: (r.addEventListener(i.start, e.scrollbar.onDragStart, n),
			  ee.addEventListener(i.move, e.scrollbar.onDragMove, n),
			  ee.addEventListener(i.end, e.scrollbar.onDragEnd, o));
	},
	disableDraggable() {
		const e = this;
		if (!e.params.scrollbar.el) return;
		...
		le.touch
			? (r.removeEventListener(s.start, e.scrollbar.onDragStart, n),
			  r.removeEventListener(s.move, e.scrollbar.onDragMove, n),
			  r.removeEventListener(s.end, e.scrollbar.onDragEnd, o))
			: (r.removeEventListener(i.start, e.scrollbar.onDragStart, n),
			  ee.removeEventListener(i.move, e.scrollbar.onDragMove, n),
			  ee.removeEventListener(i.end, e.scrollbar.onDragEnd, o));
	},
	init() {
		const e = this;
		if (!e.params.scrollbar.el) return;
		...
		0 === r.length &&
			((r = ae(`<div class="${e.params.scrollbar.dragClass}"></div>`)), a.append(r)),
			oe.extend(t, { $el: a, el: a[0], $dragEl: r, dragEl: r[0] }),
...
const We = {
	...
	onGestureStart(e) {
		const t = this,
			...
			i = t.zoom,
			{ gesture: a } = i;
		if (((i.fakeGestureTouched = !1), (i.fakeGestureMoved = !1), !le.gestures)) {
			if ('touchstart' !== e.type || ('touchstart' === e.type && e.targetTouches.length < 2))
				return;
			(i.fakeGestureTouched = !0), (a.scaleStart = We.getDistanceBetweenTouches(e));
		}
		(a.$slideEl && a.$slideEl.length) ||
		((a.$slideEl = ae(e.target).closest(`.${t.params.slideClass}`)),
	...
	onGestureChange(e) {
		...
		if (!le.gestures) {
			...
			(s.fakeGestureMoved = !0), (i.scaleMove = We.getDistanceBetweenTouches(e));
		}
		i.$imageEl &&
			0 !== i.$imageEl.length &&
			((s.scale = le.gestures
	...
	onGestureEnd(e) {
		...
		if (!le.gestures) {
			...
			if (
				'touchend' !== e.type ||
				('touchend' === e.type && e.changedTouches.length < 2 && !ve.android)
			)
				return;
	...
	onTouchMove(e) {
		const t = this,
			s = t.zoom,
			{ gesture: i, image: a, velocity: r } = s;
		if (!i.$imageEl || 0 === i.$imageEl.length) return;
		if (((t.allowClick = !1), !a.isTouched || !i.$slideEl)) return;
		a.isMoved ||
			((a.width = i.$imageEl[0].offsetWidth),
			(a.height = i.$imageEl[0].offsetHeight),
			(a.startX = oe.getTranslate(i.$imageWrapEl[0], 'x') || 0),
			(a.startY = oe.getTranslate(i.$imageWrapEl[0], 'y') || 0),
	...
	onTouchEnd() {
		...
		0 !== i.x && (a = Math.abs((o - s.currentX) / i.x)),
			0 !== i.y && (r = Math.abs((d - s.currentY) / i.y));
		...
		(s.minX = Math.min(t.slideWidth / 2 - c / 2, 0)),
			...
			t.$imageWrapEl.transition(p).transform(`translate3d(${s.currentX}px, ${s.currentY}px,0)`);
	},
	onTransitionEnd() {
		const e = this.zoom,
			{ gesture: t } = e;
		...
		if (
			(a.$slideEl ||
				(t.params.virtual && t.params.virtual.enabled && t.virtual
					? (a.$slideEl = t.$wrapperEl.children(`.${t.params.slideActiveClass}`))
			...
			return;
		let n, o, l, d, p, c, h, u, m, g, f, v, w, b, y, x, S, E;
	...
	enable() {
		...
		const s = !(
			...
			i = !le.passiveListener || { passive: !1, capture: !0 },
...
const qe = {
									...
									: (d && (n.attr('srcset', d), n.removeAttr('data-srcset')),
									  ...
									  c.length &&
											c.children('source').each((e, t) => {
												const s = ae(t);
												s.attr('data-srcset') &&
													(s.attr('srcset', s.attr('data-srcset')), s.removeAttr('data-srcset'));
											}),
	...
	load() {
		...
		function d(e) {
			return r ? ae(e).attr('data-swiper-slide-index') : ae(e).index();
		}
		if (
			('auto' === o && (o = 0),
			...
			t.children(`.${s.slideVisibleClass}`).each((t, s) => {
				const i = r ? ae(s).attr('data-swiper-slide-index') : ae(s).index();
				e.lazy.loadInSlide(i);
			});
		else if (o > 1) for (let t = a; t < a + o; t += 1) l(t) && e.lazy.loadInSlide(t);
	...
	getInterpolateFunction(e) {
		...
		t.controller.spline ||
			(t.controller.spline = t.params.loop
				? new je.LinearSpline(t.slidesGrid, e.slidesGrid)
				: new je.LinearSpline(t.snapGrid, e.snapGrid));
	},
	setTranslate(e, t) {
		const s = this,
		...
		function n(e) {
			...
			'slide' === s.params.controller.by &&
				(s.controller.getInterpolateFunction(e), (r = -s.controller.spline.interpolate(-t))),
				(r && 'container' !== s.params.controller.by) ||
					((a = (e.maxTranslate() - e.minTranslate()) / (s.maxTranslate() - s.minTranslate())),
					(r = (t - s.minTranslate()) * a + e.minTranslate())),
		...
		if (Array.isArray(i))
			for (let e = 0; e < i.length; e += 1) i[e] !== t && i[e] instanceof Pe && n(i[e]);
		else i instanceof Pe && t !== i && n(i);
	},
	setTransition(e, t) {
		const s = this,
			i = s.controller.control;
		...
		if (Array.isArray(i))
			for (a = 0; a < i.length; a += 1) i[a] !== t && i[a] instanceof Pe && r(i[a]);
		else i instanceof Pe && t !== i && r(i);
	},
};
const Ue = {
...
const Ke = {
	init() {
		...
		if (!se.history || !se.history.pushState)
			return (e.params.history.enabled = !1), void (e.params.hashNavigation.enabled = !0);
		const t = e.history;
		(t.initialized = !0),
			(t.paths = Ke.getPathValues()),
			(t.paths.key || t.paths.value) &&
				(t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit),
				e.params.history.replaceState ||
					se.addEventListener('popstate', e.history.setHistoryPopState));
	},
	destroy() {
		const e = this;
		e.params.history.replaceState ||
			se.removeEventListener('popstate', e.history.setHistoryPopState);
	},
	setHistoryPopState() {
		(this.history.paths = Ke.getPathValues()),
			this.history.scrollToSlide(this.params.speed, this.history.paths.value, !1);
	},
	getPathValues() {
		const e = se.location.pathname
				.slice(1)
				.split('/')
				.filter((e) => '' !== e),
			t = e.length;
	...
	setHistory(e, t) {
		...
		let i = Ke.slugify(s.attr('data-history'));
		se.location.pathname.includes(e) || (i = `${e}/${i}`);
		const a = se.history.state;
		(a && a.value === i) ||
			(this.params.history.replaceState
				? se.history.replaceState({ value: i }, null, i)
				: se.history.pushState({ value: i }, null, i));
	},
	slugify: (e) =>
		e
			.toString()
	...
	scrollToSlide(e, t, s) {
		...
		if (t)
			for (let a = 0, r = i.slides.length; a < r; a += 1) {
				...
				if (Ke.slugify(r.attr('data-history')) === t && !r.hasClass(i.params.slideDuplicateClass)) {
					const t = r.index();
					i.slideTo(t, e, s);
				}
			}
...
const Qe = {
	onHashCange() {
		const e = this;
		e.emit('hashChange');
		const t = ee.location.hash.replace('#', '');
	...
	setHash() {
		...
		if (e.hashNavigation.initialized && e.params.hashNavigation.enabled)
			if (e.params.hashNavigation.replaceState && se.history && se.history.replaceState)
				...
				(ee.location.hash = s || ''), e.emit('hashSet');
			}
	},
	init() {
		const e = this;
		...
		e.params.hashNavigation.watchState && ae(se).on('hashchange', e.hashNavigation.onHashCange);
	},
	destroy() {
		const e = this;
		e.params.hashNavigation.watchState && ae(se).off('hashchange', e.hashNavigation.onHashCange);
	},
};
const Ze = {
	run() {
		...
		t.attr('data-swiper-autoplay') &&
			...
			(e.autoplay.timeout = oe.nextTick(() => {
		...
		o.shadow &&
			(l
				? ((p = t.find('.swiper-cube-shadow')),
				  0 === p.length && ((p = ae('<div class="swiper-cube-shadow"></div>')), t.append(p)),
				  p.css({ height: `${i}px` }))
				: ((p = e.find('.swiper-cube-shadow')),
				  0 === p.length && ((p = ae('<div class="swiper-cube-shadow"></div>')), e.append(p))));
		for (let e = 0; e < s.length; e += 1) {
			const t = s.eq(e);
			let i = e;
			...
			if (
				(h <= 1 && h > -1 && ((c = 90 * i + 90 * h), r && (c = 90 * -i - 90 * h)),
				t.transform(f),
				o.slideShadows)
			) {
				...
				0 === e.length &&
					((e = ae(`<div class="swiper-slide-shadow-${l ? 'left' : 'top'}"></div>`)), t.append(e)),
					0 === s.length &&
						((s = ae(`<div class="swiper-slide-shadow-${l ? 'right' : 'bottom'}"></div>`)),
						t.append(s)),
		...
		if (
			...
			if (l)
				...
				const e = Math.abs(c) - 90 * Math.floor(Math.abs(c) / 90),
					...
					r = o.shadowOffset;
				p.transform(
					`scale3d(${s}, 1, ${i}) translate3d(0px, ${a / 2 + r}px, ${-a / 2 / i}px) rotateX(-90deg)`
				);
			}
		const h = _e.isSafari || _e.isWebView ? -n / 2 : 0;
		t.transform(
			`translate3d(0px,0,${h}px) rotateX(${this.isHorizontal() ? 0 : c}deg) rotateY(${
	...
	setTranslate() {
		...
		for (let i = 0; i < t.length; i += 1) {
			...
			let n = -180 * r,
				...
				d = 0;
			if (
				(e.isHorizontal() ? s && (n = -n) : ((d = l), (l = 0), (o = -n), (n = 0)),
				...
				0 === t.length &&
					((t = ae(`<div class="swiper-slide-shadow-${e.isHorizontal() ? 'left' : 'top'}"></div>`)),
					a.append(t)),
					0 === s.length &&
						((s = ae(
...
const st = {
	setTranslate() {
		...
		for (let e = 0, t = s.length; e < t; e += 1) {
			...
			const w = `translate3d(${f}px,${g}px,${u}px)  rotateX(${h}deg) rotateY(${c}deg) scale(${v})`;
			if ((t.transform(w), (t[0].style.zIndex = 1 - Math.abs(Math.round(o))), r.slideShadows)) {
				let e = n ? t.find('.swiper-slide-shadow-left') : t.find('.swiper-slide-shadow-top'),
					s = n ? t.find('.swiper-slide-shadow-right') : t.find('.swiper-slide-shadow-bottom');
				0 === e.length &&
					((e = ae(`<div class="swiper-slide-shadow-${n ? 'left' : 'top'}"></div>`)), t.append(e)),
					0 === s.length &&
						((s = ae(`<div class="swiper-slide-shadow-${n ? 'right' : 'bottom'}"></div>`)),
						t.append(s)),
					e.length && (e[0].style.opacity = o > 0 ? o : 0),
					s.length && (s[0].style.opacity = -o > 0 ? -o : 0);
			}
		}
		if (le.pointerEvents || le.prefixedPointerEvents) {
...
const it = {
	init() {
		...
		t.swiper instanceof s
			? ((e.thumbs.swiper = t.swiper),
			  ...
			  oe.extend(e.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 }))
			: oe.isObject(t.swiper) &&
	...
	onThumbClick() {
		...
		const s = t.clickedIndex,
			i = t.clickedSlide;
		if (i && ae(i).hasClass(e.params.thumbs.slideThumbActiveClass)) return;
		if (null == s) return;
		let a;
		if (
			((a = t.params.loop ? parseInt(ae(t.clickedSlide).attr('data-swiper-slide-index'), 10) : s),
			e.params.loop)
		) {
			let t = e.activeIndex;
	...
	update(e) {
		...
		if (t.realIndex !== s.realIndex || r) {
			...
			if (s.params.loop) {
				...
				(n = void 0 === e ? i : void 0 === i ? e : i - l == l - e ? l : i - l < l - e ? i : e),
		...
		else for (let e = 0; e < n; e += 1) s.slides.eq(t.realIndex + e).addClass(o);
	},
};
const at = [
	ke,
		...
		create() {
			oe.extend(this, {
				navigation: {
					...
					onNextClick: He.onNextClick.bind(this),
					onPrevClick: He.onPrevClick.bind(this),
				},
			});
		},
		on: {
			...
			click(e) {
				...
				if (t.params.navigation.hideOnClick && !ae(e.target).is(i) && !ae(e.target).is(s)) {
					let e;
					s
		...
		on: {
			...
			click(e) {
				...
				if (
					...
					!ae(e.target).hasClass(t.params.pagination.bulletClass)
				) {
		...
		create() {
			oe.extend(this, {
				scrollbar: {
					...
					updateSize: Fe.updateSize.bind(this),
					setTranslate: Fe.setTranslate.bind(this),
					setTransition: Fe.setTransition.bind(this),
					enableDraggable: Fe.enableDraggable.bind(this),
					disableDraggable: Fe.disableDraggable.bind(this),
					setDragPosition: Fe.setDragPosition.bind(this),
					getPointerPosition: Fe.getPointerPosition.bind(this),
					onDragStart: Fe.onDragStart.bind(this),
					onDragMove: Fe.onDragMove.bind(this),
					onDragEnd: Fe.onDragEnd.bind(this),
					isTouched: !1,
					timeout: null,
					dragTimeout: null,
				},
		...
		create() {
			oe.extend(this, {
				lazy: {
					...
					load: qe.load.bind(this),
					loadInSlide: qe.loadInSlide.bind(this),
				},
			});
		},
		on: {
...
void 0 === Pe.use && ((Pe.use = Pe.Class.use), (Pe.installModule = Pe.Class.installModule)),
	Pe.use(at);
var rt =
...
!(function (e, t) {
	...
	if (e && 'undefined' != typeof document) {
		...
		(a.type = 'text/css'),
			'top' === s && i.firstChild ? i.insertBefore(a, i.firstChild) : i.appendChild(a),
			a.styleSheet ? (a.styleSheet.cssText = e) : a.appendChild(document.createTextNode(e));
	}
})(rt);
const ot = window.loadCardHelpers ? window.loadCardHelpers() : void 0;
...
const lt = (e) =>
	'function' == typeof e.getCardSize
		? e.getCardSize()
		: customElements.get(e.localName)
		? 1
		: customElements.whenDefined(e.localName).then(() => lt(e));
customElements.define(
	'swipe-card',
	class extends Q {
		static get properties() {
			return { _config: {}, _cards: {} };
		}
		static getStubConfig() {
			return { cards: [] };
		}
		shouldUpdate(e) {
			return !(!e.has('_config') && !e.has('_cards'));
		}
		static get styles() {
			return U`
      :host {
      ...
      ${((e = rt), new j(String(e), q))}
    `;
			var e;
		}
		setConfig(e) {
			if (!e || !e.cards || !Array.isArray(e.cards)) throw new Error('Card config incorrect');
			(this._config = e),
				(this._parameters = nt(this._config.parameters) || {}),
				(this._cards = []),
      ...
      >
        <ha-card id="swiper-wrapper" class="swiper-wrapper">
          <style>.swiper-wrapper {background: none !important;}</style>
          ${this._cards}
        </ha-card>
        ${'pagination' in this._parameters ? O` <div class="swiper-pagination"></div> ` : ''}
        ${
        ...
        ${'scrollbar' in this._parameters ? O` <div class="swiper-scrollbar"></div> ` : ''}
      </div>
    `
				: O``;
		}
		async _initialLoad() {
			(this._loaded = !0),
				...
				'pagination' in this._parameters &&
					(null === this._parameters.pagination && (this._parameters.pagination = {}),
					(this._parameters.pagination.el = this.shadowRoot.querySelector('.swiper-pagination'))),
				'navigation' in this._parameters &&
					(null === this._parameters.navigation && (this._parameters.navigation = {}),
					(this._parameters.navigation.nextEl =
						this.shadowRoot.querySelector('.swiper-button-next')),
					(this._parameters.navigation.prevEl =
						this.shadowRoot.querySelector('.swiper-button-prev'))),
				'scrollbar' in this._parameters &&
					(null === this._parameters.scrollbar && (this._parameters.scrollbar = {}),
		...
		_setResetTimer() {
			this._resetTimer && window.clearTimeout(this._resetTimer),
				...
				}, 1e3 * this._config.reset_after));
		}
		async _createCards() {
			(this._cardPromises = Promise.all(this._config.cards.map((e) => this._createCardElement(e)))),
		...
		async _createCardElement(e) {
			const t = (await ot).createCardElement(e);
			return (
				(t.className = 'swiper-slide'),
				'card_width' in this._config && (t.style.width = this._config.card_width),
				this._hass && (t.hass = this._hass),
				t.addEventListener(
					'll-rebuild',
					(s) => {
						s.stopPropagation(), this._rebuildCard(t, e);
					},
					{ once: !0 }
				),
				t
		...
		async _rebuildCard(e, t) {
			const s = await this._createCardElement(t);
			e.replaceWith(s),
				this._cards.splice(this._cards.indexOf(e), 1, s),
				this._ro.observe(s),
				this.swiper.update();
		}
		async getCardSize() {
			if ((await this._cardPromises, !this._cards)) return 0;
			const e = [];
			for (const t of this._cards) e.push(lt(t));
