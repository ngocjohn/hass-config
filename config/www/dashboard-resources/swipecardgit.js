!(function (e, t) {
					...
					for (; p.nextNode(); ) {
						...
						if (1 === t.nodeType) {
							if (t.hasAttributes()) {
								...
								let r = 0;
								for (let e = 0; e < a.length; e++) a[e].value.indexOf(n) >= 0 && r++;
								for (; r-- > 0; ) {
									const a = e.strings[s],
										r = u.exec(a)[2],
										n = r.toLowerCase() + d,
										o = t.getAttribute(n).split(l);
									this.parts.push({ type: 'attribute', index: i, name: r, strings: o }),
										t.removeAttribute(n),
										(s += o.length - 1);
								}
							}
							...
							if (e.indexOf(n) >= 0) {
								const r = t.parentNode,
									...
									o = n.length - 1;
								for (let e = 0; e < o; e++)
									r.insertBefore('' === n[e] ? h() : document.createTextNode(n[e]), t),
										this.parts.push({ type: 'node', index: ++i });
								'' === n[o] ? (r.insertBefore(h(), t), a.push(t)) : (t.data = n[o]), (s += o);
							}
						} else if (8 === t.nodeType)
							if (t.data === n) {
								const e = t.parentNode;
								(null !== t.previousSibling && i !== c) || (i++, e.insertBefore(h(), t)),
									(c = i),
									this.parts.push({ type: 'node', index: i }),
	...
	class m {
		constructor(e, t, i) {
			(this._parts = []), (this.template = e), (this.processor = t), (this.options = i);
		}
		update(e) {
			let t = 0;
					...
					if (c(e))
						if (a === e.index) {
							if ('node' === e.type) {
								...
								this._parts.push(
									...this.processor.handleAttributeExpressions(n, e.name, e.strings, this.options)
								);
							s++;
						} else a++, 'TEMPLATE' === n.nodeName && r(n.content), (n = i.nextNode());
	...
	const f = (e) => null === e || !('object' == typeof e || 'function' == typeof e);
	class v {
		constructor(e, t, i) {
		...
		_getValue() {
			...
			for (let s = 0; s < t; s++) {
				...
				if (void 0 !== t) {
					const e = t.value;
					if (null != e && (Array.isArray(e) || ('string' != typeof e && e[Symbol.iterator])))
	...
	class b {
		...
		insertAfterPart(e) {
			e._insert((this.startNode = h())), (this.endNode = e.endNode), (e.endNode = this.startNode);
		}
		setValue(e) {
	...
	class S {
		...
		commit() {
			...
			const e = this._pendingValue,
				...
				s =
					null == e ||
					(null != i && (e.capture !== i.capture || e.once !== i.once || e.passive !== i.passive)),
				r = null != e && (null == i || s);
	...
	const T = (e) => e && (E ? { capture: e.capture, passive: e.passive, once: e.once } : e.capture);
	const k = new (class {
	...
	function $(e) {
		let t = M.get(e.type);
		void 0 === t && ((t = { stringsArray: new WeakMap(), keyString: new Map() }), M.set(e.type, t));
	...
	const O = (e) => (t) => {
			const i = I(t.type, e);
			let s = M.get(i);
			void 0 === s && ((s = { stringsArray: new WeakMap(), keyString: new Map() }), M.set(i, s));
			let a = s.stringsArray.get(t.strings);
			if (void 0 !== a) return a;
			const r = t.strings.join(n);
			if (void 0 === (a = s.keyString.get(r))) {
				const i = t.getTemplateElement();
				N && window.ShadyCSS.prepareTemplateDom(i, e), (a = new p(t, i)), s.keyString.set(r, a);
			}
		...
		V = (e, t, i) => {
			...
			if (0 === s.length) return void window.ShadyCSS.prepareTemplateStyles(t.element, i);
			...
			if (
				...
				(function (e, t, i = null) {
					...
					for (; r.nextNode(); )
						for (
							l++, r.currentNode === i && ((o = _(t)), i.parentNode.insertBefore(t, i));
							-1 !== n && a[n].index === l;
	...
	const Y = {
		...
		B = (e, t) => t !== e && (t == t || e == e),
		G = { attribute: !0, type: String, converter: Y, reflect: !1, hasChanged: B },
		R = Promise.resolve(!0),
		X = 1,
		q = 4,
		j = 8,
	...
	const de = {
		...
		on: function (...e) {
			...
			function r(e) {
				...
				if ((a.indexOf(e) < 0 && a.unshift(e), oe(t).is(i))) s.apply(t, a);
					...
					for (let t = 0; t < e.length; t += 1) oe(e[t]).is(i) && s.apply(e[t], a);
				}
			}
			function n(e) {
					...
					if (
						...
						for (let e = n.length - 1; e >= 0; e -= 1) {
							...
							s && i.listener === s
								...
								: s && i.listener && i.listener.dom7proxy && i.listener.dom7proxy === s
								? (r.removeEventListener(t, i.proxyListener, a), n.splice(e, 1))
								: s || (r.removeEventListener(t, i.proxyListener, a), n.splice(e, 1));
						}
				}
			}
			return this;
		...
		trigger: function (...e) {
			...
			for (let s = 0; s < t.length; s += 1) {
				...
				for (let t = 0; t < this.length; t += 1) {
					...
					let r;
					try {
						r = new re.CustomEvent(a, { detail: i, bubbles: !0, cancelable: !0 });
					} catch (e) {
		...
		transitionEnd: function (e) {
			...
			let s;
			function a(r) {
				if (r.target === this) for (e.call(this, r), s = 0; s < t.length; s += 1) i.off(t[s], a);
			}
		...
		eq: function (e) {
			...
			const t = this.length;
			let i;
			return new ne(e > t - 1 ? [] : e < 0 ? ((i = t + e) < 0 ? [] : [this[i]]) : [this[e]]);
		},
		append: function (...e) {
			let t;
		...
		parents: function (e) {
			...
			for (let i = 0; i < this.length; i += 1) {
				...
				for (; s; ) e ? oe(s).is(e) && t.push(s) : t.push(s), (s = s.parentNode);
			}
			return oe(le(t));
		},
		closest: function (e) {
	...
	const pe = {
		...
		he = (function () {
			return {
				isIE: !!re.navigator.userAgent.match(/Trident/g) || !!re.navigator.userAgent.match(/MSIE/g),
	...
	class ue {
		...
		static installModule(e, ...t) {
			...
			const s = e.name || `${Object.keys(i.prototype.modules).length}_${pe.now()}`;
			return (
	...
	var me = {
		updateSize: function () {
			...
			(t = void 0 !== e.params.width ? e.params.width : s[0].clientWidth),
				...
				(0 === t && e.isHorizontal()) ||
					...
					pe.extend(e, { width: t, height: i, size: e.isHorizontal() ? t : i }));
		},
		updateSlides: function () {
				...
				if ('none' !== a.css('display')) {
					if ('auto' === t.slidesPerView) {
						...
						(w = (s - (t.slidesPerView - 1) * b) / t.slidesPerView),
							t.roundLengths && (w = Math.floor(w)),
							l[i] &&
								(e.isHorizontal() ? (l[i].style.width = `${w}px`) : (l[i].style.height = `${w}px`));
			...
			if (
				...
				for (let i = 0; i < p.length; i += 1) {
					let s = p[i];
					t.roundLengths && (s = Math.floor(s)), p[i] < e.virtualSize + p[0] && k.push(s);
				}
				p = k;
			}
			if (!t.centeredSlides) {
				...
				for (let i = 0; i < p.length; i += 1) {
					let a = p[i];
					t.roundLengths && (a = Math.floor(a)), p[i] <= e.virtualSize - s && k.push(a);
				}
				(p = k),
			...
			pe.extend(e, { slides: l, snapGrid: p, slidesGrid: c, slidesSizesGrid: h }),
		...
		updateSlidesProgress: function (e = (this && this.translate) || 0) {
			...
			for (let e = 0; e < s.length; e += 1) {
				const n = s[e],
					o =
						(r + (i.centeredSlides ? t.minTranslate() : 0) - n.swiperSlideOffset) /
						(n.swiperSlideSize + i.spaceBetween);
				if (i.watchSlidesVisibility) {
					const a = -(r - n.swiperSlideOffset),
						o = a + t.slidesSizesGrid[e];
					((a >= 0 && a < t.size) || (o > 0 && o <= t.size) || (a <= 0 && o >= t.size)) &&
		...
		updateSlidesClasses: function () {
			const e = this,
				{ slides: t, params: i, $wrapperEl: s, activeIndex: a, realIndex: r } = e,
			...
			t.removeClass(
				...
				(o = n
					? e.$wrapperEl.find(`.${i.slideClass}[data-swiper-slide-index="${a}"]`)
		...
		updateActiveIndex: function (e) {
			const t = this,
				...
				{ slidesGrid: s, snapGrid: a, params: r, activeIndex: n, realIndex: o, snapIndex: l } = t;
			let d,
				p = e;
			if (void 0 === p) {
				for (let e = 0; e < s.length; e += 1)
			...
			if (
				((d = a.indexOf(i) >= 0 ? a.indexOf(i) : Math.floor(p / r.slidesPerGroup)) >= a.length &&
					(d = a.length - 1),
				p === n)
			)
				return void (d !== l && ((t.snapIndex = d), t.emit('snapIndexChange')));
			const c = parseInt(t.slides.eq(p).attr('data-swiper-slide-index') || p, 10);
			pe.extend(t, { snapIndex: d, realIndex: c, previousIndex: n, activeIndex: p }),
		...
		updateClickedSlide: function (e) {
			...
			(t.clickedSlide = s),
				t.virtual && t.params.virtual.enabled
					? (t.clickedIndex = parseInt(oe(s).attr('data-swiper-slide-index'), 10))
	...
	var ge = {
		...
		setTranslate: function (e, t) {
			...
			(o = 0 === p ? 0 : (e - i.minTranslate()) / p) !== n && i.updateProgress(e),
	...
	var ve = {
		slideTo: function (e = 0, t = this.params.speed, i = !0, s) {
			...
			if (a.initialized && r !== p) {
				...
				if (!a.allowSlidePrev && u > a.translate && u > a.maxTranslate() && (p || 0) !== r)
					return !1;
			}
			let m;
			return (
		...
		slidePrev: function (e = this.params.speed, t = !0, i) {
			const s = this,
				{ params: a, animating: r, snapGrid: n, slidesGrid: o, rtlTranslate: l } = s;
			if (a.loop) {
				if (r) return !1;
			...
			let u;
			return (
				void 0 !== h && (u = o.indexOf(h)) < 0 && (u = s.activeIndex - 1), s.slideTo(u, e, t, i)
			);
		},
		...
		loopCreate: function () {
			...
			if (t.loopFillGroupWithBlank) {
				...
				if (e !== t.slidesPerGroup) {
					for (let s = 0; s < e; s += 1) {
						const e = oe(ae.createElement('div')).addClass(`${t.slideClass} ${t.slideBlankClass}`);
						i.append(e);
					}
	...
	var be = {
		setGrabCursor: function (e) {
			if (ce.touch || !this.params.simulateTouch || (this.params.watchOverflow && this.isLocked))
				return;
			const t = this.el;
			(t.style.cursor = 'move'),
		...
		unsetGrabCursor: function () {
			ce.touch || (this.params.watchOverflow && this.isLocked) || (this.el.style.cursor = '');
		},
	};
	var ye = {
		...
		prependSlide: function (e) {
			...
			i.loop && t.loopCreate(), (i.observer && ce.observer) || t.update(), t.slideTo(r, 0, !1);
		},
		addSlide: function (e, t) {
			...
			let n = r;
			a.loop &&
				((n -= i.loopedSlides), i.loopDestroy(), (i.slides = s.children(`.${a.slideClass}`)));
		...
		removeSlide: function (e) {
			...
			let r = a;
			i.loop &&
				((r -= t.loopedSlides), t.loopDestroy(), (t.slides = s.children(`.${i.slideClass}`)));
			let n,
				o = r;
			if ('object' == typeof e && 'length' in e) {
				for (let i = 0; i < e.length; i += 1)
				...
				(n = e), t.slides[n] && t.slides.eq(n).remove(), n < o && (o -= 1), (o = Math.max(o, 0));
			i.loop && t.loopCreate(),
					...
					(e.onTouchStart = function (e) {
						...
						(e.onTouchMove = function (e) {
							...
							if ((n.originalEvent && (n = n.originalEvent), !i.isTouched))
								return void (i.startMoving && i.isScrolling && t.emit('touchMoveOpposite', n));
							if (i.isTouchEvent && 'mousemove' === n.type) return;
							const o = 'touchmove' === n.type ? n.targetTouches[0].pageX : n.pageX,
							...
							if (!t.allowTouchMove)
								return (
									...
									void (
										i.isTouched &&
										(pe.extend(a, { startX: o, startY: l, currentX: o, currentY: l }),
										(i.touchStartTime = pe.now()))
									)
								);
							...
							if (
								...
								c > 0 && i.currentTranslate > t.minTranslate()
									? ((h = !1),
									  s.resistance &&
											(i.currentTranslate =
												t.minTranslate() - 1 + (-t.minTranslate() + i.startTranslate + c) ** u))
									: c < 0 &&
									  i.currentTranslate < t.maxTranslate() &&
									  ((h = !1),
									  s.resistance &&
											(i.currentTranslate =
												t.maxTranslate() + 1 - (t.maxTranslate() - i.startTranslate - c) ** u)),
						...
						(e.onTouchEnd = function (e) {
							...
							if (
								(t.allowClick &&
									...
									c < 300 &&
										p - i.lastClickTime < 300 &&
										(i.clickTimeout && clearTimeout(i.clickTimeout), t.emit('doubleTap', d))),
							...
							if (c > s.longSwipesMs) {
								...
								'next' === t.swipeDirection &&
									(g >= s.longSwipesRatio ? t.slideTo(u + s.slidesPerGroup) : t.slideTo(u)),
									'prev' === t.swipeDirection &&
										(g > 1 - s.longSwipesRatio ? t.slideTo(u + s.slidesPerGroup) : t.slideTo(u));
							} else {
				...
				pe.extend(s, {
					...
					touchEvents: (function () {
						...
						return (
							...
							ce.touch || !s.params.simulateTouch ? s.touchEventsTouch : s.touchEventsDesktop
						);
					})(),
					touchEventsData: {
						isTouched: void 0,
		...
		changeDirection(e, t = !0) {
			...
			return (
				...
				e === s || ('horizontal' !== e && 'vertical' !== e)
					...
					: ('vertical' === s &&
							(i.$el
								.removeClass(`${i.params.containerModifierClass}vertical wp8-vertical`)
					  ...
					  'horizontal' === s &&
							(i.$el
								.removeClass(`${i.params.containerModifierClass}horizontal wp8-horizontal`)
								.addClass(`${i.params.containerModifierClass}${e}`),
							(he.isIE || he.isEdge) &&
								(ce.pointerEvents || ce.prefixedPointerEvents) &&
								i.$el.addClass(`${i.params.containerModifierClass}wp8-${e}`)),
		...
		destroy(e = !0, t = !0) {
			...
			return void 0 === i.params || i.destroyed
				...
				: (i.emit('beforeDestroy'),
				  ...
				  !1 !== e && ((i.$el[0].swiper = null), i.$el.data('swiper', null), pe.deleteProps(i)),
				  (i.destroyed = !0),
				  null);
		}
	...
	const _e = {
		update(e) {
			...
			if (
				(pe.extend(t.virtual, { from: v, to: w, offset: b, slidesGrid: t.slidesGrid }),
				o === v && l === w && !e)
			)
			...
			for (let t = 0; t < d.length; t += 1)
				t >= v &&
					t <= w &&
					(void 0 === l || e ? C.push(t) : (t > l && C.push(t), t < o && x.push(t)));
			C.forEach((e) => {
		...
		renderSlide(e, t) {
			...
			const a = s.renderSlide
				...
				: oe(`<div class="${i.params.slideClass}" data-swiper-slide-index="${t}">${e}</div>`);
			return (
	...
	const Ie = {
		...
		enable() {
			this.keyboard.enabled ||
				(oe(ae).on('keydown', this.keyboard.handle), (this.keyboard.enabled = !0));
		},
		disable() {
			this.keyboard.enabled &&
				(oe(ae).off('keydown', this.keyboard.handle), (this.keyboard.enabled = !1));
		},
	};
	var Ne = {
		name: 'keyboard',
	...
	const Fe = {
		...
		init() {
			...
			t.nextEl &&
				...
				pe.extend(e.navigation, { $nextEl: i, nextEl: i && i[0], $prevEl: s, prevEl: s && s[0] });
		},
		destroy() {
			const e = this,
	...
	const He = {
		update() {
			...
			if (
				...
				if (
					(i.dynamicBullets &&
						...
						(l = ((o = n + (Math.min(s.length, i.dynamicMainBullets) - 1)) + n) / 2)),
					s.removeClass(
			...
			'custom' === i.type && i.renderCustom
				? (a.html(i.renderCustom(e, r + 1, n)), e.emit('paginationRender', e, a[0]))
	...
	const Ve = {
		...
		enableDraggable() {
			...
			const { scrollbar: t, touchEventsTouch: i, touchEventsDesktop: s, params: a } = e,
				r = t.$el[0],
				n = !(!ce.passiveListener || !a.passiveListeners) && { passive: !1, capture: !1 },
				o = !(!ce.passiveListener || !a.passiveListeners) && { passive: !0, capture: !1 };
			ce.touch
		...
		init() {
			...
			0 === r.length &&
				((r = oe(`<div class="${e.params.scrollbar.dragClass}"></div>`)), a.append(r)),
	...
	const Ye = {
		...
		setTransition(e = this.params.speed) {
			const { $el: t } = this;
			t.find('[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y]').each(
				(t, i) => {
					const s = oe(i);
	...
	const Be = {
		...
		onGestureStart(e) {
			const t = this,
				...
				s = t.zoom,
				{ gesture: a } = s;
			if (((s.fakeGestureTouched = !1), (s.fakeGestureMoved = !1), !ce.gestures)) {
				if ('touchstart' !== e.type || ('touchstart' === e.type && e.targetTouches.length < 2))
					return;
				(s.fakeGestureTouched = !0), (a.scaleStart = Be.getDistanceBetweenTouches(e));
			}
		...
		in(e) {
			...
			if (
				(a.$slideEl ||
					((a.$slideEl = t.clickedSlide ? oe(t.clickedSlide) : t.slides.eq(t.activeIndex)),
					(a.$imageEl = a.$slideEl.find('img, svg, canvas')),
		...
		out() {
			const e = this,
				...
				{ gesture: s } = t;
			s.$slideEl ||
				((s.$slideEl = e.clickedSlide ? oe(e.clickedSlide) : e.slides.eq(e.activeIndex)),
	...
	const Re = {
		...
		setTranslate(e, t) {
			...
			function n(e) {
				...
				'slide' === i.params.controller.by &&
					...
					(r && 'container' !== i.params.controller.by) ||
						((a = (e.maxTranslate() - e.minTranslate()) / (i.maxTranslate() - i.minTranslate())),
			...
			if (Array.isArray(s))
				for (let e = 0; e < s.length; e += 1) s[e] !== t && s[e] instanceof ke && n(s[e]);
		...
		setTransition(e, t) {
			...
			if (Array.isArray(s))
				for (a = 0; a < s.length; a += 1) s[a] !== t && s[a] instanceof ke && r(s[a]);
	...
	const je = {
		...
		setHash() {
			...
			if (e.hashNavigation.initialized && e.params.hashNavigation.enabled)
				if (e.params.hashNavigation.replaceState && re.history && re.history.replaceState)
	...
	const Ke = {
		setTranslate() {
			...
			for (let e = 0; e < i.length; e += 1) {
				...
				if (
					(h <= 1 && h > -1 && ((c = 90 * s + 90 * h), r && (c = 90 * -s - 90 * h)),
					t.transform(f),
					o.slideShadows)
				) {
					...
					0 === e.length &&
						((e = oe(`<div class="swiper-slide-shadow-${l ? 'left' : 'top'}"></div>`)),
						t.append(e)),
						0 === i.length &&
							((i = oe(`<div class="swiper-slide-shadow-${l ? 'right' : 'bottom'}"></div>`)),
							t.append(i)),
		...
		setTranslate() {
			...
			for (let s = 0; s < t.length; s += 1) {
				...
				let n = -180 * r,
					...
					d = 0;
				if (
					(e.isHorizontal() ? i && (n = -n) : ((d = l), (l = 0), (o = -n), (n = 0)),
	...
	const Ze = {
		setTranslate() {
			const { width: e, height: t, slides: i, $wrapperEl: s, slidesSizesGrid: a } = this,
			...
			for (let e = 0, t = i.length; e < t; e += 1) {
				...
				if ((t.transform(f), (t[0].style.zIndex = 1 - Math.abs(Math.round(o))), r.slideShadows)) {
					let e = n ? t.find('.swiper-slide-shadow-left') : t.find('.swiper-slide-shadow-top'),
						i = n ? t.find('.swiper-slide-shadow-right') : t.find('.swiper-slide-shadow-bottom');
					0 === e.length &&
						((e = oe(`<div class="swiper-slide-shadow-${n ? 'left' : 'top'}"></div>`)),
						t.append(e)),
						0 === i.length &&
							((i = oe(`<div class="swiper-slide-shadow-${n ? 'right' : 'bottom'}"></div>`)),
							t.append(i)),
	...
	const Qe = {
		init() {
			...
			t.swiper instanceof i
				? ((e.thumbs.swiper = t.swiper),
				  ...
				  pe.extend(e.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 }))
		...
		onThumbClick() {
			...
			let a;
			if (
				((a = t.params.loop ? parseInt(oe(t.clickedSlide).attr('data-swiper-slide-index'), 10) : i),
				e.params.loop)
			) {
				let t = e.activeIndex;
		...
		update(e) {
			...
			if (t.realIndex !== i.realIndex) {
				...
				if (i.params.loop) {
					i.slides.eq(r).hasClass(i.params.slideDuplicateClass) &&
						(i.loopFix(), (i._clientLeft = i.$wrapperEl[0].clientLeft), (r = i.activeIndex));
					const e = i.slides
							.eq(r)
				...
				i.visibleSlidesIndexes.indexOf(a) < 0 &&
					(i.params.centeredSlides
						? (a = a > r ? a - Math.floor(s / 2) + 1 : a + Math.floor(s / 2) - 1)
						: a > r && (a = a - s + 1),
			...
			else for (let e = 0; e < a; e += 1) i.slides.eq(t.realIndex + e).addClass(r);
		},
	};
	const et = [
		$e,
		...
		},
		{
			...
			on: {
				...
				click(e) {
					...
					if (t.params.navigation.hideOnClick && !oe(e.target).is(s) && !oe(e.target).is(i)) {
						let e;
						i
	...
	void 0 === ke.use && ((ke.use = ke.Class.use), (ke.installModule = ke.Class.installModule)),
		ke.use(et);
	var tt =
	...
	function dt(e) {
		return function (t, i, s) {
			var a = s[e].indexOf(i.charAt(0).toUpperCase() + i.substr(1).toLowerCase());
			~a && (t.month = a);
		};
	}
	function pt(e, t) {
	...
	var gt = {
			...
			ZZ: function (e) {
				...
				return (t > 0 ? '-' : '+') + pt(100 * Math.floor(Math.abs(t) / 60) + (Math.abs(t) % 60), 4);
			},
		},
		ft = {
			D: [
			...
			ZZ: [
				...
				function (e, t) {
					var i,
						s = (t + '').match(/([+-]|\d\d)/gi);
					s && ((i = 60 * s[1] + parseInt(s[2], 10)), (e.timezoneOffset = '+' === s[0] ? i : -i));
				},
			],
		};
	(ft.dd = ft.d),
		...
		(st.parse = function (e, t, i) {
			...
			var o,
				l = ((o = t), o.replace(/[|\\{()[^$+*?.-]/g, '\\$&')).replace(at, function (e) {
					if (ft[e]) {
						var t = ft[e];
				...
				(t.prototype.bind = function (e) {
					...
					if (!e.longPress) {
						...
						var i = function (i) {
							...
							s = function (i) {
								t.cooldownEnd ||
								(['touchend', 'touchcancel'].includes(i.type) && void 0 === t.timer)
									? e.isRepeating &&
									  t.repeatTimeout &&
									  (clearInterval(t.repeatTimeout), (e.isRepeating = !1))
									: (clearTimeout(t.timer),
									  e.isRepeating && t.repeatTimeout && clearInterval(t.repeatTimeout),
									  (e.isRepeating = !1),
									  t.stopAnimation(),
									  (t.timer = void 0),
									  t.held
											...
											? 0 === t.nbClicks
												? ((t.nbClicks += 1),
												  (t.dblClickTimeout = window.setTimeout(function () {
														1 === t.nbClicks &&
															((t.nbClicks = 0), e.dispatchEvent(new Event('ha-click')));
												  }, 250)))
												: ((t.nbClicks = 0),
      ...
      `,
			...
			setConfig(e) {
				...
				(this._config = it(e)),
					...
					(this._cards = this._config.cards.map((e) => this._createCardElement(e)));
			}
			set hass(e) {
				(this._hass = e),
					this._cards &&
			...
			_createCardElement(e) {
				...
				if (e.type.startsWith(yt)) {
					...
					if (customElements.get(s)) t = window.document.createElement(`${s}`);
						...
						(i = { type: 'error', error: `Custom element doesn't exist: ${s}.`, cardConfig: e }),
							((t = window.document.createElement('hui-error-card')).style.display = 'None');
